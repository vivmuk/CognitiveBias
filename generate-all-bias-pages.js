...
<body class="bias-detail-body">
    ...
    <div class="bias-page-shell">
        <div class="navigation-bar">
            ...
            <div class="nav-right">
                <span class="nav-pill" id="biasCounter">Bias #${biasId} / 99</span>
                <div class="nav-controls">
                    <a href="bias-${prevId}.html" class="ghost-button">Previous</a>
                    <a href="bias-${nextId}.html" class="ghost-button">Next</a>
                </div>
            </div>
        </div>
...
console.log('Generating bias pages 1-99...');
...
console.log('Done! Generated all pages from 1 to 99.');
